<template>
  <div class="player" v-show='playlist.length > 0'>
      <transition class='normal' 
        ...
        <div class="normal-player" v-show='fullScreen'>
          ...
          <div  class="middle" 
            ...
            <div class="middle-l" ref='milldeL'>
      ...
      <transition class='mini' name='mini'>
  ...
  export default {
    ...
    methods: {
      ...
      middleTouchMove(e) {
        ...
        if(Math.abs(deltaY) > Math.abs(deltaX)) { //认为是纵向滚动
          return
        }
        ...
        this.$refs.lyricList.$el.style[transform] = `translate3d(${offetWidth}px, 0, 0)`;
        this.$refs.milldeL.style.opacity = 1 - this.touch.percent;
        this.$refs.milldeL.style[transitionDuration] = 0;
      },
      middleTouchEnd() {
        let offetWidth;
        let opacity;
        ...
        this.$refs.lyricList.$el.style[transform] = `translate3d(${offetWidth}px, 0, 0)`;
        this.$refs.milldeL.style.opacity = opacity;
        this.$refs.milldeL.style[transitionDuration] = `${time}ms`;
      },
      _pad(num, n = 2) {
    ...
    watch: {
      currentSong(newSong, oldSonge) {
        if(newSong.id === oldSonge.id) {
          return;
        }
        // stop当前的currentlyric
        if(this.currentLyric) {
